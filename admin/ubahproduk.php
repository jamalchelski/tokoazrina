...
<form method="post" enctype="multipart/form-data">
	<div class="form-group">
		<label>Nama</label>
		<input type="text" class="form-control" value="<?php echo $pecah['nama_produk']; ?>" name="nama">
	</div>
	<div class="form-group">
		<label>Harga(Rp.)</label>
		<input type="number" class="form-control" value="<?php echo $pecah['harga_produk']; ?>" name="harga">
	</div>
	<div class="form-group">
		<label>Berat(Gr.)</label>
		<input type="number" class="form-control" value="<?php echo $pecah['berat_produk']; ?>" name="berat">
	</div>
	<div class="form-group">
